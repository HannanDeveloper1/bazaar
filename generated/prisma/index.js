...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\hanna\\OneDrive\\Desktop\\Code Playground\\bazaar\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\hanna\\OneDrive\\Desktop\\Code Playground\\bazaar\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "mongodb+srv://hannandeveloper1:pDFwZJOrqZi4sq9B@cluster0.fwnwqii.mongodb.net/development"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel images {\n  id      String  @id @default(auto()) @map(\"_id\") @db.ObjectId\n  file_id String\n  url     String\n  userId  String? @unique @db.ObjectId\n  users   users?  @relation(fields: [userId], references: [id])\n}\n\nmodel users {\n  id        String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name      String\n  email     String   @unique\n  password  String?\n  following String[]\n  avatar    images?\n  createdAt DateTime @default(now())\n  updateAt  DateTime @default(now())\n  imagesId  String   @db.ObjectId\n}\n",
  "inlineSchemaHash": "d498381f4e656c50443f856e772023c799e8d309c85e1854239f8a962d512605",
  "copyEngine": true
}
